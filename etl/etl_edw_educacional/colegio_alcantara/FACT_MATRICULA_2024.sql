...
-- 2. Inserción limpia de alumnos 1 al 336
WITH Fechas2024 AS (
...
SELECT 
    ...
    -- Esta fórmula agrupa a los alumnos en 12 cursos exactos (28 alumnos por curso)
    -- Alumnos 1-28 -> Curso 1 | Alumnos 29-56 -> Curso 2 | ... | Alumnos 309-336 -> Curso 12
...
FROM [dbo].[DIM_ALUMNO]
WHERE ALUMNO_KEY BETWEEN 1 AND 336;
GO
